...
- [maven配置文件](../images/files/maven-setting.xml)

<section class="img-flex-box" >
  <section>将上面的maven配置文件下载保存到本地，文件名为maven-setting.xml</section>
  <section><img class="lazy-image" data-src="../images/java/idea-config-0001.png" alt=""></section>
  <section><img class="lazy-image" data-src="../images/java/idea-config-0002.png" alt=""></section>
  <section><img class="lazy-image" data-src="../images/java/idea-config-0003.png" alt=""></section>
  <section><img class="lazy-image" data-src="../images/java/idea-config-0004.png" alt=""></section>
</section>
